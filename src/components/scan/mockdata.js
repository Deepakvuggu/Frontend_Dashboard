...
export const activityLog = [
    { t: "[09:00:00]", txt: "I'll begin a systematic penetration test on helpdesk.democomp.com. Let me start with reconnaissance and enumeration." },
    { t: "[09:01:00]", txt: "Good! target is online. Now let me perform port scanning to identify running services." },
    { t: "[09:02:00]", txt: "Excellent reconnaissance results:\n- helpdesk.democomp.com: Apache httpd 2.4.65 on port 80 (web server)\nLet me probe the web server on target first to understand its structure." },
    { t: "[09:03:00]", txt: "Great! I found a login page for a Help Desk Platform. I can see a useful comment: \"TODO: Delete the testing account (test:test)\". Let me test this credential." },
    { t: "[09:04:00]", txt: "The POST method is not allowed on /password/test. Let me check if the page posts to # which means the current page. Let me try a different approach." },
    { t: "[09:05:00]", txt: "It redirects back to /password/test. Let me check if there's an /api endpoint or look for other paths. Let me also try with the test:test password directly on other endpoints." },
    { t: "[09:06:00]", txt: "I can access the dashboard using the \"X-UserId: 1032\" header. The dashboard shows \"Welcome, John Doe\". This suggests an IDOR vulnerability. Let me explore more..." },
];
